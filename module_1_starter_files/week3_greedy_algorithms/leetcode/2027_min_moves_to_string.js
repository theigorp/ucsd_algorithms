/*
  *EASY
  ...
  LOGIC:
  We will select the first three characters and check if they contain X. If yes, that means we need to convert them, therefore minMoves is incremented. Since we "converted" those 3 characters
  ...
  OPTIMIZATION:
  The runtime is O(n^2). Optimal solution below is O(n).
*/
